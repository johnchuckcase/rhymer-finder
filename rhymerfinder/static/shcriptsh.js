$(document).ready(function() {
    //
    $("#input-div").on("click", ".plus-btn", function() {
      ($("#input-div")).append('<form class="pure-form" style="display: inline">\
      <input type="email" id="lyric-input" placeholder="Enter Lyrics" class="input-form" size=50></form>\
      <div class="plus-btn" style="display: inline">+</div>');
      var pbtn = $('.plus-btn').first();
      pbtn.removeClass('plus-btn');
      pbtn.addClass('minus-btn')
      pbtn.text('-')
    })
